...
//
//    public ProductImage(@NotNull(message = "Image URL must not be null.") @NotBlank(message = "Image URL must not be blank.") String url, boolean primaryImage, Product product) {
//
//    }
//
//    @Override
